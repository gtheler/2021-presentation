...
Transfinite Curve {8, 9, 10, 5} = 2/Mesh.MeshSizeFactor+1;
Transfinite Curve {1, 2} = 3/Mesh.MeshSizeFactor+1;
Transfinite Curve {3, 7} = 4/Mesh.MeshSizeFactor+1;
Transfinite Curve {4, 6} = 2/Mesh.MeshSizeFactor+1;
Transfinite Surface {1} = {2, 3, 5, 4};
Transfinite Surface {2} = {4, 5, 7, 6};
Transfinite Surface {3} = {6, 7, 9, 8};

Extrude {{0, 0, 1}, {0, 0, 0}, Pi/2} {
  Surface{1}; Surface{2}; Surface{3}; Layers{6/Mesh.MeshSizeFactor}; Recombine;
}
