...
Transfinite Curve {-1, 3, -14, 6, 11, 18} = 4/Mesh.MeshSizeFactor+1 Using Progression 1.02;
Transfinite Curve {5, 17, 7, 10, 19} = 6/Mesh.MeshSizeFactor+1 Using Progression 1.02;
Transfinite Curve {-9} = 6/Mesh.MeshSizeFactor+1 Using Progression 1.02;
